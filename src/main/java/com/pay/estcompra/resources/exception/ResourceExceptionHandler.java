package com.pay.estcompra.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataIntegredy(DataIntegrityViolationException e, HttpServletRequest request) {		
