...
import com.pay.estcompra.domain.Estado;
import com.pay.estcompra.domain.ItemPedido;
import com.pay.estcompra.domain.Pagamento;
import com.pay.estcompra.domain.PagamentoComBoleto;
import com.pay.estcompra.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p6 = new Produto(null, "Clocha", 200.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "caiopereiraleal1998@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "caiopereira1994@gmail.com", "28482480332", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("981416789", "991175567"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "56777823", cli2, c2);
